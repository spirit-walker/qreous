...
Sys.StringBuilder = function (a) {
    this._parts = typeof a !== 'undefined' && a !== null && a !== '' ? [
        a.toString()
    ] : [
    ];
    this._value = {
...
Sys.Observer._collectionChange = function (d, c) {
    ...
    if (a && a.updating) {
        ...
        Sys.Observer.raiseCollectionChanged(d, [
            c
        ]);
...
Sys.Observer.insert = function (a, b, c) {
    Array.insert(a, b, c);
    Sys.Observer._collectionChange(a, new Sys.CollectionChange(Sys.NotifyCollectionChangedAction.add, [
        c
    ], b))
};
Sys.Observer.remove = function (a, b) {
    ...
    if (c !== - 1) {
        Array.remove(a, b);
        Sys.Observer._collectionChange(a, new Sys.CollectionChange(Sys.NotifyCollectionChangedAction.remove, null, - 1, [
            b
        ], c));
        return true
    }
...
Sys.Observer.removeAt = function (b, a) {
    if (a > - 1 && a < b.length) {
        var c = b[a];
        Array.removeAt(b, a);
        Sys.Observer._collectionChange(b, new Sys.CollectionChange(Sys.NotifyCollectionChangedAction.remove, null, - 1, [
            c
        ], a))
    }
};
...
Date._getParseRegExp = function (b, e) {
    ...
    a.append('$');
    var k = a.toString().replace(/\s+/g, '\\libs+'),
        g = {
            'regExp': k,
            'groups': j
        };
...
function Sys$Component$_setProperties(a, i) {
    ...
    for (var c in i) {
        ...
        if (e || typeof f !== 'function') {
            ...
            var l = a['set_' + c];
            if (typeof l === 'function') l.apply(a, [
                b
            ]);
...
Sys._ScriptLoaderTask.prototype = {
    ...
    _removeScriptElementHandlers: function () {
        if (this._scriptLoadDelegate) {
            ...
            if (this._useReadyState()) $removeHandler(a, 'readystatechange', this._scriptLoadDelegate);
...
Sys.Net.WebServiceProxy.invoke = function (q, a, m, l, j, b, g, e, w, p) {
    var i = w !== false ? Sys.Net.WebServiceProxy._xdomain.exec(q)  : null,
        c,
        n = i && i.length === 3 && (i[1] !== location.protocol || i[2] !== location.host);
    m = n || m;
    if (n) {
        p = p || 'callback';
        c = '_jsonp' + Sys._jsonp++
